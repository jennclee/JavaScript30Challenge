...
const filtered1500 = inventors.filter(element => element.year >= 1500 && element.year < 1600);
console.table(filtered1500);
...
const listItems = [];
categories.forEach(item => listItems.push([...item.querySelectorAll('li')]));
const names = [];
...
const de = names.filter(name => name.includes('de'));
*/
